...
echo "Starting the component hosts generate xshell sessions ..."

%JAVA_HOME%\bin\java -Xmx2048m -XX:-UseGCOverheadLimit -classpath ./conf;./lib/*;%CLASSPATH% com.sam.hosts.Main %PARAMS%